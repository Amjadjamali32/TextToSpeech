                        ...
                        {isOpenProfile && (
                            <div className="absolute top-10 right-0 z-50 my-4 text-base list-none rounded-lg shadow bg-gray-600" id="user-dropdown">
                                <div className="px-4 py-3">
                                    <span className="block text-sm text-gray-900 dark:text-white">Amjad Ali</span>
                                    <span className="block text-sm text-gray-500 truncate dark:text-gray-400">amjadalijamali41@gmail.com</span>
                                </div>
