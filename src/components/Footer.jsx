    ...
    return (
        <>
            <footer className="rounded-lg text-white">
                <div className="w-full max-w-screen-xl p-4 md:py-8 bg-slate-500">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <ul className="flex flex-wrap flex-col items-start mb-6 text-sm font-medium text-gray-800 sm:mb-0">
                            ...
                            <li>
                                <Link to="/" className="hover:underline hover:text-yellow-300 me-4 md:me-6">Privacy Policy</Link>
                            </li>
                            <li>
                                <Link to="/" className="hover:underline hover:text-yellow-300 me-4 md:me-6">Home</Link>
                            </li>
                            <li>
                    ...
                    <p className="block text-center text-sm sm:text-center">© 2024 <Link to="/" className="hover:underline hover:text-yellow-300">Speakify™</Link>. All Rights Reserved.</p>
                </div>
            </footer>
        </>
    )
