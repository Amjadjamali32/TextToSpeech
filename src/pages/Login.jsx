                ...
                <div className='bg-white mx-2 p-3 rounded-md shadow-lg my-2'>
                    <form className="max-w-sm mx-auto">
                        ...
                        <div className="mb-5 mt-5">
                            <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Email" required name="email" />
                        </div>
                        <div className="mb-3">
                            <input type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 rounded-sm focus:border-blue-500 block w-full p-2.5" required  placeholder='Password' name="password"/>
                        </div>
                        <div className="flex items-center flex-col mb-3">
                            ...
                            <button className='mt-1'>
                                <a href="" className='text-yellow-500 font-semibold hover:text-yellow-600'>Login as Admin</a>
                            </button>
                        </div>
